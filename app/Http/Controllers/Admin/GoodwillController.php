...
class GoodwillController extends Controller
{
    public function index($bussiness_id){
        return view('admin.goodwill.index',compact('bussiness_id'));
    }

    public function getall(Request $request,$id){
        $data = GoodWillToken::with('user')->where('bussiness_id',$id)->orderBy('id','desc')->get();
