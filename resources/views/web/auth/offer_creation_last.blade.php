	  ...
	  <div class="row mb-lg-4">
		<div class="col-lg-8 mx-auto">
		  <div id="about" class="bg-white shadow-sm rounded p-4 mb-4">
			...
			<hr>
			<form action="{{route('offer.creation.post')}}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="form-group floating-label-form-group enter-value">
				  <label>Offer Text</label>
				  <input type="hidden" name="plan_id" value="{{$plan->id}}" />
				  <input type="text" name="text" class="form-control" value="{{ old('text') }}" placeholder="Enter Offer Text">
				  @error('text')
				...
				<div class="">
					<input type="submit" class="btn btn-primary btn-block btn-lg" value="Submit Offer">
				</div>
			</form>
		</div>
		</div>
