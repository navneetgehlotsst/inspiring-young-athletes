            ...
            <tr>
               <td style="padding: 30px 30px 30px 30px;">
                  ...
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Click here for Reset Password</p>
                    <a href="{{ route('admin.reset.password.get', $token) }}" style="display:inline-block;background:#1BADC4;color:#fff;font-family:poppins;font-size:16px;font-weight:400;line-height:1;letter-spacing:1px;margin:0;text-decoration:none;text-transform:none;padding:12px 24px 12px 24px;border-radius:4px">
                        Reset Password</a></p>
                    <p>OR</p>
                    <p>Copy url and pest to the web browser :- {{ route('admin.reset.password.get', $token) }}</p>
               </td>
            </tr>
         </table>
         <!-- Body 3-->
