...
<body style="background: #F9F9F9;">
    <div style="background-color:#F9F9F9;">
                                                        ...
                                                        <tr>
                                                            <td style="width:138px;"><a href=""
                                                                    target="_blank"><img alt="" title="" height="38px"
                                                                        src="{{asset('web/assets/images/new-img/logo.svg')}}"
        ...
        <div
            ...
            <div
                style="margin:0px auto;max-width:640px;background:#7289DA url({{asset('web/assets/images/new-img/blue-bg.jpg')}}) top center / cover no-repeat;">
                <table role="presentation" cellpadding="0" cellspacing="0"
                    style="font-size:0px;width:100%;background:#7289DA url({{asset('web/assets/images/new-img/blue-bg.jpg')}}) top center / cover no-repeat;"
                    align="center" border="0"
                    background="{{asset('web/assets/images/new-img/blue-bg.jpg')}}">
                    <tbody>
                        <tr>
                            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:57px;">
                                <div
                                    style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:24px;font-weight:600;line-height:36px;text-align:center;">
                                    Welcome to Inspiring Young Athletes Registration!</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
