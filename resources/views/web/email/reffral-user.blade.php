         ...
         <table role="presentation" border="0" width="100%" cellspacing="0" style="margin-top: 20px;">
            <tr>
               <td bgcolor="#1e532e" align="center" style="background-image: url('{{asset('web/assets/images/new-img/hero-banner.jpg')}}'); color: white; height: 100px; padding: 20px 0px;">
                  <h2 style="font-family: poppins; margin-top: 20px;">Welcome to <br> Inspiring Young Athletes!</h2>
            </tr>
            </td>
         </table>
         <!-- Body 1 -->
         <table role="presentation" border="0" width="100%" cellspacing="0">
            <tr>
               <td style="padding: 30px 30px 30px 30px;">
                  <h2 style="font-size: 28px; margin:0 0 20px 0; font-family:poppins;"> Reffral Earn</h2>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Reffral send by : {{$senderemail}}</b></p>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Register link for your panel :- {{$url}}</b></p>
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Your Reffral Code :</p>
                  <p style="border: 1px solid #ccc; padding: 10px; border-radius: 5px; width: 140px; font-family:poppins; text-align: center;"><b style="color: #1BADC4; font-size: 22px;">{{$code}}</b></p>
