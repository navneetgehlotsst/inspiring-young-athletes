                ...
                <div class="collapse navbar-collapse px-3 px-lg-3" id="navbarNavDarkDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle px-2 {{ request()->is('athletes-coach/vedio*') ? 'show' : '' }}" href="#"
                                id="navbarDarkDropdownMenuLink" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="far fa-play-circle me-2"></i> Videos
                            </a>
                            <ul class="dropdown-menu {{ request()->is('athletes-coach/vedio*') ? 'show' : '' }}"
                                aria-labelledby="navbarDarkDropdownMenuLink">
                                <li><a class="dropdown-item {{ request()->is('athletes-coach/vedio/add') ? 'active' : '' }}" href="{{ route('web.vedio.add') }}">Add New Video</a></li>
                                <li><a class="dropdown-item {{ request()->is('athletes-coach/vedio/index') ? 'active' : '' }}" href="{{ route('web.vedio.index') }}">All Videos</a></li>
                            </ul>
                        </li>
