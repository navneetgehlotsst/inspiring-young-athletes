                    ...
                    <form role="form" action="{{ route('web.user.verifyotp') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-8 otp-log">
                                <div class="otp-form">
                                    <input type="number" name="otp1" class="otp-form form-control text-center otp-input" placeholder="" required>
                                </div>
                                <div class="otp-form">
                                    <input type="number" name="otp2" class="otp-form form-control text-center otp-input" placeholder="" required>
                                </div>
                                <div class="otp-form">
                                    <input type="number" name="otp3" class="otp-form form-control text-center otp-input" placeholder="" required>
                                </div>
                                <div class="otp-form">
                                    <input type="number" name="otp4" class="otp-form form-control text-center otp-input" placeholder="" required>
                                </div>
                            </div>
                        </div>
